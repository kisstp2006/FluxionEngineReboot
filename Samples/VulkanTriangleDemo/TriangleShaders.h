...
// Offline-compiled SPIR-V (glslc, Vulkan SDK 1.4.350.0) -- the RHI
// backend only ever consumes raw bytecode, no shader compiler runs as
// part of the engine build. Regenerate by recompiling the corresponding
// .vert/.frag GLSL sources with glslc.

static const unsigned char g_TriangleVertexShaderSpirv[] = {
...
static const unsigned int g_TriangleVertexShaderSpirv_size = 1080;

static const unsigned char g_TriangleFragmentShaderSpirv[] = {
...
static const unsigned int g_TriangleFragmentShaderSpirv_size = 572;
