...
void Test_AmbientOcclusionGPU_Run(TestContext* ctx);
void Test_AutoExposureGPU_Run(TestContext* ctx);
void Test_BloomGPU_Run(TestContext* ctx);
void Test_FXAAGPU_Run(TestContext* ctx);
void Test_GradingGPU_Run(TestContext* ctx);
void Test_SurfacePrepassGPU_Run(TestContext* ctx);
...
int main(void)
{
    ...
    Test_AmbientOcclusionGPU_Run(&ctx);
    Test_AutoExposureGPU_Run(&ctx);
    Test_BloomGPU_Run(&ctx);
    Test_FXAAGPU_Run(&ctx);
    Test_GradingGPU_Run(&ctx);
    Test_SurfacePrepassGPU_Run(&ctx);
